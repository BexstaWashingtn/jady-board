...
/** @typedef {{ createTaskOpen: boolean, createTaskColumnId: string, selectedTaskId: string | null, draggingTaskId: string | null, filters: import("./board.state.js").BoardFilters, undo: UndoState, notice: string | null, boardConfigOpen: boolean, stageConfigOpen: boolean, stageEditor: StageEditor, openColumnMenuId: string | null }} BoardViewState */
...
export function createBoardViewState(initialColumnId = "backlog") {
  return {
    ...
    selectedTaskId: null, draggingTaskId: null,
